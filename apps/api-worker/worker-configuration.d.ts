/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d2b9a5a74ea7a2cd22c1933294a08d2)
// Runtime types generated with workerd@1.20251213.0 2024-03-20 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "ChatState";
  }
  interface Env {
    CACHE_KV: KVNamespace;
    API_TOKEN: string;
    CHAT_STATE: DurableObjectNamespace<import("./src/index").ChatState>;
